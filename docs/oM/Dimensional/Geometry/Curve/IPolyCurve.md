...
???+ bhom "The IPolyCurve is inheriting from the following base type(s) and implements the following interfaces:"
...
``` C# title="C#"
public interface IPolyCurve : BH.oM.Geometry.ICurve, BH.oM.Geometry.IGeometry, BH.oM.Base.IObject, BH.oM.Dimensional.IElement1D, BH.oM.Dimensional.IElement
```
...
- [IPolyCurve.cs](https://github.com/BHoM/BHoM/blob/develop/Geometry_oM/Curve\IPolyCurve.cs)
...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/Geometry_oM/IPolyCurve.json"
}
```

The JSON Schema is available on github here:

- [IPolyCurve.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/Geometry_oM/IPolyCurve.json)
