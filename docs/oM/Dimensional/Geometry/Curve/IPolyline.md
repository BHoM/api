...
???+ bhom "The IPolyline is inheriting from the following base type(s) and implements the following interfaces:"
...
``` C# title="C#"
public interface IPolyline : BH.oM.Geometry.ICurve, BH.oM.Geometry.IGeometry, BH.oM.Base.IObject, BH.oM.Dimensional.IElement1D, BH.oM.Dimensional.IElement
```
...
- [IPolyline.cs](https://github.com/BHoM/BHoM/blob/develop/Geometry_oM/Curve\IPolyline.cs)
...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/Geometry_oM/IPolyline.json"
}
```

The JSON Schema is available on github here:

- [IPolyline.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/Geometry_oM/IPolyline.json)
