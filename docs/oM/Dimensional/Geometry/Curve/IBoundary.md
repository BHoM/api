...
???+ bhom "The IBoundary is inheriting from the following base type(s) and implements the following interfaces:"
...
``` C# title="C#"
public interface IBoundary : BH.oM.Geometry.ICurve, BH.oM.Geometry.IGeometry, BH.oM.Base.IObject, BH.oM.Dimensional.IElement1D, BH.oM.Dimensional.IElement
```
...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/Geometry_oM/IBoundary.json"
}
```

The JSON Schema is available on github here:

- [IBoundary.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/Geometry_oM/IBoundary.json)
