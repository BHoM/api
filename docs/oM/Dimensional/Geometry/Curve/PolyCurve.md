...
| EndPoint | [Point](/api/oM/Dimensional/Geometry/Vector/Point) | Gets the end Point of a PolyCurve. | - | Geometry_Engine |
| Geometry | [ICurve](/api/oM/Dimensional/Geometry/Curve/ICurve) | Returns the geometry of a PolyCurve as an ICurve. | - | Geometry_Engine |
...
| StartPoint | [Point](/api/oM/Dimensional/Geometry/Vector/Point) | Gets the start Point of a PolyCurve. | - | Geometry_Engine |
| SubParts | [List](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1?view=netstandard-2.0)&lt;[ICurve](/api/oM/Dimensional/Geometry/Curve/ICurve)&gt; | Gets the individual curve parts that make up a PolyCurve, recursively exploding any nested curves. | - | Geometry_Engine |
