...
| AreaAndCentroid | [Output](/api/oM/Framework/Base/Output)&lt;[Point](/api/oM/Dimensional/Geometry/Vector/Point), [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0)&gt; | Calculates both the area and centroid of a closed, planar NurbsCurve using numerical integration. | - | Geometry_Engine |
...
| Centroid | [Point](/api/oM/Dimensional/Geometry/Vector/Point) | Queries the centre of area for a NurbsCurve. | - | Geometry_Engine |
...
| Degree | [int](https://learn.microsoft.com/en-us/dotnet/api/System.Int32?view=netstandard-2.0) | Gets the degree of a NurbsCurve. | - | Geometry_Engine |
| Domain | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0)[] | Gets the domain of a NurbsCurve. | - | Geometry_Engine |
...
| EndPoint | [Point](/api/oM/Dimensional/Geometry/Vector/Point) | Gets the end Point of a NurbsCurve. For non-periodic curves, returns the last control point. | - | Geometry_Engine |
| Geometry | [ICurve](/api/oM/Dimensional/Geometry/Curve/ICurve) | Returns the geometry of a NurbsCurve as an ICurve. | - | Geometry_Engine |
...
| IsPeriodic | [bool](https://learn.microsoft.com/en-us/dotnet/api/System.Boolean?view=netstandard-2.0) | Checks if a NurbsCurve is periodic (closed with continuous derivatives). | - | Geometry_Engine |
...
| IsRational | [bool](https://learn.microsoft.com/en-us/dotnet/api/System.Boolean?view=netstandard-2.0) | Determines whether a NurbsCurve is rational by checking if any of its weights are not equal to 1. | - | Geometry_Engine |
...
| Length | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | Calculates length of a NurbsCurve. | - | Geometry_Engine |
...
| StartPoint | [Point](/api/oM/Dimensional/Geometry/Vector/Point) | Gets the start Point of a NurbsCurve. For non-periodic curves, returns the first control point. | - | Geometry_Engine |
