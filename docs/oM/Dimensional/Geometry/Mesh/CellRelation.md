...
???+ bhom "The CellRelation is inheriting from the following base type(s) and implements the following interfaces:"
...
|------------------|------------------|------------------|------------------|
| FromCell | [int](https://learn.microsoft.com/en-us/dotnet/api/System.Int32?view=netstandard-2.0) | Index of the cell the Face is connected to which its normal is pointing away from. | - |
| ToCell | [int](https://learn.microsoft.com/en-us/dotnet/api/System.Int32?view=netstandard-2.0) | Index of the cell the Face is connected to which its normal is pointing towards. | - |
...
``` C# title="C#"
public class CellRelation : BH.oM.Geometry.IGeometry, BH.oM.Base.IObject
```
...
- [CellRelation.cs](https://github.com/BHoM/BHoM/blob/develop/Geometry_oM/Mesh\CellRelation.cs)
...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/Geometry_oM/CellRelation.json"
}
```

The JSON Schema is available on github here:

- [CellRelation.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/Geometry_oM/CellRelation.json)
