...
???+ bhom "The Basis is inheriting from the following base type(s) and implements the following interfaces:"
...
|------------------|------------------|------------------|------------------|------------------|
| Bounds | [BoundingBox](/api/oM/Dimensional/Geometry/Misc/BoundingBox) | Returns the global world axis oriented BoundingBox of the Basis as an empty BoundingBox. | - | Geometry_Engine |
...
``` C# title="C#"
public class Basis : BH.oM.Geometry.IGeometry, BH.oM.Base.IObject, BH.oM.Base.IImmutable
```
...
- [Basis.cs](https://github.com/BHoM/BHoM/blob/develop/Geometry_oM/Vector\Basis.cs)
...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/Geometry_oM/Basis.json"
}
```

The JSON Schema is available on github here:

- [Basis.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/Geometry_oM/Basis.json)
### Example JSON instance

Example JSON instance of type Basis.
