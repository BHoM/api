...
???+ bhom "The FabricatedBoxProfile is inheriting from the following base type(s) and implements the following interfaces:"
...
| WeldSize | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | Fillet weld size between inside of webs and flanges. Measured as the distance between intersection of web and flange perpendicular to the edge of the weld. | [Length](/api/oM/Dimensional/Quantities/Attributes/Length) [m] |
...
| Description | [string](https://learn.microsoft.com/en-us/dotnet/api/System.String?view=netstandard-2.0) | Generates a default description for the profile as 'FabBox Height x Width x WebThickness x TopFlangeThickness x BotFlangeThickness'. | - | Structure_Engine |
...
``` C# title="C#"
public class FabricatedBoxProfile : BH.oM.Base.BHoMObject, BH.oM.Base.IBHoMObject, BH.oM.Base.IObject, BH.oM.Spatial.ShapeProfiles.IProfile, BH.oM.Base.IImmutable
```
...
- [FabricatedBoxProfile.cs](https://github.com/BHoM/BHoM/blob/develop/Spatial_oM/ShapeProfiles\FabricatedBoxProfile.cs)
...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/Spatial_oM/ShapeProfiles/FabricatedBoxProfile.json"
}
```

The JSON Schema is available on github here:

- [FabricatedBoxProfile.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/Spatial_oM/ShapeProfiles/FabricatedBoxProfile.json)
