...
???+ bhom "The Grid is inheriting from the following base type(s) and implements the following interfaces:"
...
|------------------|------------------|------------------|------------------|
| Name | [string](https://learn.microsoft.com/en-us/dotnet/api/System.String?view=netstandard-2.0) | The Grid Reference, ID or text based identifier. | - |
| Curve | [ICurve](/api/oM/Dimensional/Geometry/Curve/ICurve) | The centreline defining the Grid's path. Can be curved or linear. | - |
...
| Geometry | [ICurve](/api/oM/Dimensional/Geometry/Curve/ICurve) | Queries the defining Curve from the grid. | - | Spatial_Engine |
...
``` C# title="C#"
public class Grid : BH.oM.Base.BHoMObject, BH.oM.Base.IBHoMObject, BH.oM.Base.IObject, BH.oM.Dimensional.IElement1D, BH.oM.Dimensional.IElement
```
...
- [Grid.cs](https://github.com/BHoM/BHoM/blob/develop/Spatial_oM/SettingOut\Grid.cs)
...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/Spatial_oM/SettingOut/Grid.json"
}
```

The JSON Schema is available on github here:

- [Grid.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/Spatial_oM/SettingOut/Grid.json)
