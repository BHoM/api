...
???+ bhom "The ParamRemoved is inheriting from the following base type(s) and implements the following interfaces:"
...
``` C# title="C#"
public class ParamRemoved : BH.oM.Base.BHoMObject, BH.oM.Base.IBHoMObject, BH.oM.Base.IObject, BH.oM.UI.IParamUpdate, BH.oM.UI.IUpdate
```
...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/UI_oM/ParamRemoved.json"
}
```

The JSON Schema is available on github here:

- [ParamRemoved.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/UI_oM/ParamRemoved.json)
