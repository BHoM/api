...
???+ bhom "The ClusterNode is inheriting from the following base type(s) and implements the following interfaces:"
...
|------------------|------------------|------------------|------------------|
| Content | [ClusterContent](/api/oM/Framework/Programming/Others/ClusterContent) | - | - |
...
``` C# title="C#"
public class ClusterNode : BH.oM.Base.BHoMObject, BH.oM.Base.IBHoMObject, BH.oM.Base.IObject, BH.oM.Programming.INode
```
