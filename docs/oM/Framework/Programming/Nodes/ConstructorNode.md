...
???+ bhom "The ConstructorNode is inheriting from the following base type(s) and implements the following interfaces:"
...
|------------------|------------------|------------------|------------------|
| Constructor | [ConstructorInfo](https://learn.microsoft.com/en-us/dotnet/api/System.Reflection.ConstructorInfo?view=netstandard-2.0) | - | - |
...
``` C# title="C#"
public class ConstructorNode : BH.oM.Base.BHoMObject, BH.oM.Base.IBHoMObject, BH.oM.Base.IObject, BH.oM.Programming.INode
```
...
- [ConstructorNode.cs](https://github.com/BHoM/BHoM/blob/develop/Programming_oM/Nodes\ConstructorNode.cs)
