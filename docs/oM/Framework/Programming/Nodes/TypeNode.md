...
???+ bhom "The TypeNode is inheriting from the following base type(s) and implements the following interfaces:"
...
``` C# title="C#"
public class TypeNode : BH.oM.Base.BHoMObject, BH.oM.Base.IBHoMObject, BH.oM.Base.IObject, BH.oM.Programming.INode
```
...
- [TypeNode.cs](https://github.com/BHoM/BHoM/blob/develop/Programming_oM/Nodes\TypeNode.cs)
