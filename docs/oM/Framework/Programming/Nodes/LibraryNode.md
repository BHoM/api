...
???+ bhom "The LibraryNode is inheriting from the following base type(s) and implements the following interfaces:"
...
|------------------|------------------|------------------|------------------|
| SourceFile | [string](https://learn.microsoft.com/en-us/dotnet/api/System.String?view=netstandard-2.0) | - | - |
...
``` C# title="C#"
public class LibraryNode : BH.oM.Base.BHoMObject, BH.oM.Base.IBHoMObject, BH.oM.Base.IObject, BH.oM.Programming.INode
```
...
- [LibraryNode.cs](https://github.com/BHoM/BHoM/blob/develop/Programming_oM/Nodes\LibraryNode.cs)
