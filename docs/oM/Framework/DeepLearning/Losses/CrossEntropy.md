...
???+ bhom "The CrossEntropy is inheriting from the following base type(s) and implements the following interfaces:"
...
``` C# title="C#"
public class CrossEntropy : BH.oM.Base.BHoMObject, BH.oM.Base.IBHoMObject, BH.oM.Base.IObject, BH.oM.DeepLearning.IModule
```
...
- [CrossEntropy.cs](https://github.com/BHoM/BHoM/blob/develop/DeepLearning_oM/Losses\CrossEntropy.cs)
