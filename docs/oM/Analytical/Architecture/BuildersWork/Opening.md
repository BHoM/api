...
|------------------|------------------|------------------|------------------|
| Profile | [IProfile](/api/oM/Dimensional/Spatial/ShapeProfiles/IProfile) | Profile of the opening. | - |
| Depth | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | Total depth of the opening, distributed equally from the origin in both directions along the local z axis. | [Length](/api/oM/Dimensional/Quantities/Attributes/Length) [m] |
| CoordinateSystem | [Cartesian](/api/oM/Dimensional/Geometry/CoordinateSystem/Cartesian) | Local coordinate system of the opening with local z being the direction along the opening, local x representing direction along width in plane and y along height respectively. | - |
...
| Geometry | [Point](/api/oM/Dimensional/Geometry/Vector/Point) | Extracts geometry of the given BuildersWork Opening. | - | Architecture_Engine |
...
``` C# title="C#"
public class Opening : BH.oM.Base.BHoMObject, BH.oM.Base.IBHoMObject, BH.oM.Base.IObject, BH.oM.Dimensional.IElement0D, BH.oM.Dimensional.IElement
```
...
- [Opening.cs](https://github.com/BHoM/BHoM/blob/develop/Architecture_oM/BuildersWork\Opening.cs)
...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/Architecture_oM/BuildersWork/Opening.json"
}
```

The JSON Schema is available on github here:

- [Opening.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/Architecture_oM/BuildersWork/Opening.json)
