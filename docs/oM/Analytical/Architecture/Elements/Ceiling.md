...
???+ bhom "The Ceiling is inheriting from the following base type(s) and implements the following interfaces:"
...
|------------------|------------------|------------------|------------------|
| Surface | [ISurface](/api/oM/Dimensional/Geometry/Surface/ISurface) | - | - |
| Construction | [Construction](/api/oM/Physical/Physical/Constructions/Construction) | - | - |
| Tiles | [List](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1?view=netstandard-2.0)&lt;[CeilingTile](/api/oM/Analytical/Architecture/Elements/CeilingTile)&gt; | - | - |
...
| OutlineElements1D | [List](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1?view=netstandard-2.0)&lt;[IElement1D](/api/oM/Dimensional/Dimensional/IElement1D)&gt; | Returns the outline 1D elements of an Architecture Ceiling | - | Architecture_Engine |
...
``` C# title="C#"
public class Ceiling : BH.oM.Base.BHoMObject, BH.oM.Base.IBHoMObject, BH.oM.Base.IObject, BH.oM.Dimensional.IElement2D, BH.oM.Dimensional.IElement
```
...
- [Ceiling.cs](https://github.com/BHoM/BHoM/blob/develop/Architecture_oM/Elements\Ceiling.cs)
...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/Architecture_oM/Elements/Ceiling.json"
}
```

The JSON Schema is available on github here:

- [Ceiling.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/Architecture_oM/Elements/Ceiling.json)
