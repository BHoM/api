...
| OutlineElements1D | [List](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1?view=netstandard-2.0)&lt;[IElement1D](/api/oM/Dimensional/Dimensional/IElement1D)&gt; | Returns the outline 1D elements of an Architecture Room | - | Architecture_Engine |
...
``` C# title="C#"
public class Room : BH.oM.Base.BHoMObject,
...
- [Room.cs](https://github.com/BHoM/BHoM/blob/develop/Architecture_oM/Elements\Room.cs)
...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/Architecture_oM/Elements/Room.json"
}
```

The JSON Schema is available on github here:

- [Room.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/Architecture_oM/Elements/Room.json)
