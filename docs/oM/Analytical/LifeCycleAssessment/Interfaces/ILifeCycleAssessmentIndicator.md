---
title: ILifeCycleAssessmentIndicator
---

# <small>BH.oM.LifeCycleAssessment.Interfaces.</small>**ILifeCycleAssessmentIndicator**

Base interface for all classes classes storing indicator factors or results.

## Interface structure

### Implemented interfaces and base types

???+ bhom "The ILifeCycleAssessmentIndicator is inheriting from the following base type(s) and implements the following interfaces:"
...
``` C# title="C#"
public interface ILifeCycleAssessmentIndicator : BH.oM.Base.IObject
```
...
- [ILifeCycleAssessmentIndicator.cs](https://github.com/BHoM/BHoM/blob/develop/LifeCycleAssessment_oM/Interfaces\ILifeCycleAssessmentIndicator.cs)
...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/LifeCycleAssessment_oM/Interfaces/ILifeCycleAssessmentIndicator.json"
}
```

The JSON Schema is available on github here:

- [ILifeCycleAssessmentIndicator.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/LifeCycleAssessment_oM/Interfaces/ILifeCycleAssessmentIndicator.json)
