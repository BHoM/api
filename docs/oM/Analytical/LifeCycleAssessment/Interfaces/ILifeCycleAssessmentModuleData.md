...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/LifeCycleAssessment_oM/Interfaces/ILifeCycleAssessmentModuleData`1.json"
}
```

The JSON Schema is available on github here:

- [ILifeCycleAssessmentModuleData`1.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/LifeCycleAssessment_oM/Interfaces/ILifeCycleAssessmentModuleData`1.json)
