...
???+ bhom "The ClimateChangeBiogenicMaterialResult is inheriting from the following base type(s) and implements the following interfaces:"
...
``` C# title="C#"
public class ClimateChangeBiogenicMaterialResult : BH.oM.LifeCycleAssessment.Results.MaterialResult,
...
- [ClimateChangeBiogenicMaterialResult.cs](https://github.com/BHoM/BHoM/blob/develop/LifeCycleAssessment_oM/Results\MaterialResults\ClimateChangeBiogenicMaterialResult.cs)
...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/LifeCycleAssessment_oM/Results/ClimateChangeBiogenicMaterialResult.json"
}
```

The JSON Schema is available on github here:

- [ClimateChangeBiogenicMaterialResult.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/LifeCycleAssessment_oM/Results/ClimateChangeBiogenicMaterialResult.json)
