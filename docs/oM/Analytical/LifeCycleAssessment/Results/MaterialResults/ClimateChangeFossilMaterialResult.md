...
???+ bhom "The ClimateChangeFossilMaterialResult is inheriting from the following base type(s) and implements the following interfaces:"
...
``` C# title="C#"
public class ClimateChangeFossilMaterialResult : BH.oM.LifeCycleAssessment.Results.MaterialResult,
...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/LifeCycleAssessment_oM/Results/ClimateChangeFossilMaterialResult.json"
}
```

The JSON Schema is available on github here:

- [ClimateChangeFossilMaterialResult.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/LifeCycleAssessment_oM/Results/ClimateChangeFossilMaterialResult.json)
