...
???+ bhom "The ClimateChangeTotalNoBiogenicMaterialResult is inheriting from the following base type(s) and implements the following interfaces:"
...
``` C# title="C#"
public class ClimateChangeTotalNoBiogenicMaterialResult : BH.oM.LifeCycleAssessment.Results.MaterialResult,
...
- [ClimateChangeTotalNoBiogenicMaterialResult.cs](https://github.com/BHoM/BHoM/blob/develop/LifeCycleAssessment_oM/Results\MaterialResults\ClimateChangeTotalNoBiogenicMaterialResult.cs)
...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/LifeCycleAssessment_oM/Results/ClimateChangeTotalNoBiogenicMaterialResult.json"
}
```

The JSON Schema is available on github here:

- [ClimateChangeTotalNoBiogenicMaterialResult.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/LifeCycleAssessment_oM/Results/ClimateChangeTotalNoBiogenicMaterialResult.json)
