...
???+ bhom "The ClimateChangeTotalMaterialResult is inheriting from the following base type(s) and implements the following interfaces:"
...
``` C# title="C#"
public class ClimateChangeTotalMaterialResult : BH.oM.LifeCycleAssessment.Results.MaterialResult,
...
- [ClimateChangeTotalMaterialResult.cs](https://github.com/BHoM/BHoM/blob/develop/LifeCycleAssessment_oM/Results\MaterialResults\ClimateChangeTotalMaterialResult.cs)
...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/LifeCycleAssessment_oM/Results/ClimateChangeTotalMaterialResult.json"
}
```

The JSON Schema is available on github here:

- [ClimateChangeTotalMaterialResult.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/LifeCycleAssessment_oM/Results/ClimateChangeTotalMaterialResult.json)
