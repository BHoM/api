...
???+ bhom "The ClimateChangeBiogenicMetric is inheriting from the following base type(s) and implements the following interfaces:"
...
``` C# title="C#"
public class ClimateChangeBiogenicMetric : BH.oM.Base.BHoMObject,
...
- [ClimateChangeBiogenicMetric.cs](https://github.com/BHoM/BHoM/blob/develop/LifeCycleAssessment_oM/MaterialFragments\EnvironmentalMetrics\ClimateChangeBiogenicMetric.cs)
...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/LifeCycleAssessment_oM/MaterialFragments/ClimateChangeBiogenicMetric.json"
}
```

The JSON Schema is available on github here:

- [ClimateChangeBiogenicMetric.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/LifeCycleAssessment_oM/MaterialFragments/ClimateChangeBiogenicMetric.json)
