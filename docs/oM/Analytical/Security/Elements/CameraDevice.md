...
???+ bhom "The CameraDevice is inheriting from the following base type(s) and implements the following interfaces:"
...
|------------------|------------------|------------------|------------------|
| EyePosition | [Point](/api/oM/Dimensional/Geometry/Vector/Point) | The point at which the Camera is installed, known as the eye position. | - |
| TargetPosition | [Point](/api/oM/Dimensional/Geometry/Vector/Point) | The point at which the Camera is looking at, known as the target position. | - |
| Angle | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | Angle of the Camera, known as the real-world angle of what the camera views. | [Angle](/api/oM/Dimensional/Quantities/Attributes/Angle) [rad] |
| Mounting | [MountingType](/api/oM/Analytical/Security/Enums/MountingType) | The Camera mounting type that describes how it's installed. | - |
| Type | [CameraType](/api/oM/Analytical/Security/Enums/CameraType) | The Camera type that describes its characteristics. | - |
| Megapixels | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | The Camera megapixels that determines its image quality. | - |
...
| Centreline | [Line](/api/oM/Dimensional/Geometry/Curve/Line) | Returns the centreline of a CameraDevice object. | - | Security_Engine |
...
| Geometry | [ICurve](/api/oM/Dimensional/Geometry/Curve/ICurve) | Gets the camera's geometry as a closed ICurve cone-shape. Method required for automatic display in UI packages. | - | Security_Engine |
...
- [CameraDevice.cs](https://github.com/BHoM/BHoM/blob/develop/Security_oM/Elements\CameraDevice.cs)
...
- [CameraDevice.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/Security_oM/Elements/CameraDevice.json)
