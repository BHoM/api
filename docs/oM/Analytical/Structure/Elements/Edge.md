...
| InvalidEdge | [bool](https://learn.microsoft.com/en-us/dotnet/api/System.Boolean?view=netstandard-2.0) | Checks whether an edge is invalid for use in Lusas. An edge is invalid if it is null, has a null curve, or is defined by a curve that is not a Line. | - | Lusas_Engine |
