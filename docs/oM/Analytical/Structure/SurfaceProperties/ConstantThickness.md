...
???+ bhom "The ConstantThickness is inheriting from the following base type(s) and implements the following interfaces:"
...
|------------------|------------------|------------------|------------------|------------------|
| Construction | [Construction](/api/oM/Physical/Physical/Constructions/Construction) | Creates a physical Construction from a structural ConstantThickness SurfaceProperty. Extracts the Structural MaterialFragment and creates a physical material with the same name. | - | Structure_Engine |
...
| Description | [string](https://learn.microsoft.com/en-us/dotnet/api/System.String?view=netstandard-2.0) | Generates a default description for the SurfaceProperty as 'THK Thickness - MaterialName'. | - | Structure_Engine |
...
``` C# title="C#"
public class ConstantThickness : BH.oM.Base.BHoMObject,
...
- [ConstantThickness.cs](https://github.com/BHoM/BHoM/blob/develop/Structure_oM/SurfaceProperties\ConstantThickness.cs)
...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/Structure_oM/SurfaceProperties/ConstantThickness.json"
}
```

The JSON Schema is available on github here:

- [ConstantThickness.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/Structure_oM/SurfaceProperties/ConstantThickness.json)
