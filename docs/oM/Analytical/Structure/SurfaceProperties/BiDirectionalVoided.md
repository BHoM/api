...
- [BiDirectionalVoided.cs](https://github.com/BHoM/BHoM/blob/develop/Structure_oM/SurfaceProperties\BiDirectionalVoided.cs)
...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/Structure_oM/SurfaceProperties/BiDirectionalVoided.json"
}
```

The JSON Schema is available on github here:

- [BiDirectionalVoided.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/Structure_oM/SurfaceProperties/BiDirectionalVoided.json)
