...
???+ bhom "The ExplicitSection is inheriting from the following base type(s) and implements the following interfaces:"
...
``` C# title="C#"
public class ExplicitSection : BH.oM.Base.BHoMObject,
...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/Structure_oM/SectionProperties/ExplicitSection.json"
}
```

The JSON Schema is available on github here:

- [ExplicitSection.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/Structure_oM/SectionProperties/ExplicitSection.json)
