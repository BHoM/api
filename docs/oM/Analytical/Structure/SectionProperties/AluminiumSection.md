...
???+ bhom "The AluminiumSection is inheriting from the following base type(s) and implements the following interfaces:"
...
``` C# title="C#"
public class AluminiumSection : BH.oM.Base.BHoMObject,
...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/Structure_oM/SectionProperties/AluminiumSection.json"
}
```

The JSON Schema is available on github here:

- [AluminiumSection.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/Structure_oM/SectionProperties/AluminiumSection.json)
