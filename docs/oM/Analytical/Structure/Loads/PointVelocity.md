...
???+ bhom "The PointVelocity is inheriting from the following base type(s) and implements the following interfaces:"
...
|------------------|------------------|------------------|------------------|
| TranslationalVelocity | [Vector](/api/oM/Dimensional/Geometry/Vector/Vector) | - | [Velocity](/api/oM/Dimensional/Quantities/Attributes/Velocity) [m/s] |
| RotationalVelocity | [Vector](/api/oM/Dimensional/Geometry/Vector/Vector) | - | [AngularVelocity](/api/oM/Dimensional/Quantities/Attributes/AngularVelocity) [rad/s] |
...
``` C# title="C#"
public class PointVelocity : BH.oM.Base.BHoMObject,
...
- [PointVelocity.cs](https://github.com/BHoM/BHoM/blob/develop/Structure_oM/Loads\PointVelocity.cs)
