...
???+ bhom "The BarPrestressLoad is inheriting from the following base type(s) and implements the following interfaces:"
...
|------------------|------------------|------------------|------------------|
| Prestress | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | Prestress force to be applied to the Bar. Positive for tension, negative for compression. | [Force](/api/oM/Dimensional/Quantities/Attributes/Force) [N] |
...
``` C# title="C#"
public class BarPrestressLoad : BH.oM.Base.BHoMObject,
