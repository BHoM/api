...
???+ bhom "The AreaUniformlyDistributedLoad is inheriting from the following base type(s) and implements the following interfaces:"
...
|------------------|------------------|------------------|------------------|
| Pressure | [Vector](/api/oM/Dimensional/Geometry/Vector/Vector) | The force per area to be applied to the elements. | [Pressure](/api/oM/Dimensional/Quantities/Attributes/Pressure) [Pa] |
...
| Visualize | [List](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1?view=netstandard-2.0)&lt;[ICurve](/api/oM/Dimensional/Geometry/Curve/ICurve)&gt; | Draws arrows representing the area load, either as a grid over the element, or along the boundary of the elements. | - | Structure_Engine |
