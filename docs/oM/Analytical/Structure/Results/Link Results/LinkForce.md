...
# <small>BH.oM.Structure.Results.</small>**LinkForce**

Resulting forces in local coordinates along the general link.

## Class structure

### Implemented interfaces and base types

???+ bhom "The LinkForce is inheriting from the following base type(s) and implements the following interfaces:"
...
|------------------|------------------|------------------|------------------|
| FX | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | Axial force along the local x-axis. | [Force](/api/oM/Dimensional/Quantities/Attributes/Force) [N] |
...
``` C# title="C#"
public class LinkForce : BH.oM.Structure.Results.LinkResult,
...
- [LinkForce.cs](https://github.com/BHoM/BHoM/blob/develop/Structure_oM/Results\Link Results\LinkForce.cs)
...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/Structure_oM/Results/LinkForce.json"
}
```

The JSON Schema is available on github here:

- [LinkForce.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/Structure_oM/Results/LinkForce.json)
