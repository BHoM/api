...
# <small>BH.oM.Structure.Results.</small>**BarResult**
...
???+ bhom "The BarResult is inheriting from the following base type(s) and implements the following interfaces:"
...
``` C# title="C#"
public abstract class BarResult : BH.oM.Structure.Results.IStructuralResult,
...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/Structure_oM/Results/BarResult.json"
}
```

The JSON Schema is available on github here:

- [BarResult.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/Structure_oM/Results/BarResult.json)
