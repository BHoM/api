...
???+ bhom "The BarDisplacement is inheriting from the following base type(s) and implements the following interfaces:"
...
``` C# title="C#"
public class BarDisplacement : BH.oM.Structure.Results.BarResult,
...
- [BarDisplacement.cs](https://github.com/BHoM/BHoM/blob/develop/Structure_oM/Results\Bar Results\BarDisplacement.cs)
