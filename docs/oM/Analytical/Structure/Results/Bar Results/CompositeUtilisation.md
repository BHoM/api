...
???+ bhom "The CompositeUtilisation is inheriting from the following base type(s) and implements the following interfaces:"
...
``` C# title="C#"
public class CompositeUtilisation : BH.oM.Structure.Results.BarResult,
