...
???+ bhom "The StructuralGlobalResult is inheriting from the following base type(s) and implements the following interfaces:"
...
``` C# title="C#"
public abstract class StructuralGlobalResult : BH.oM.Structure.Results.IStructuralResult,
...
- [StructuralGlobalResult.cs](https://github.com/BHoM/BHoM/blob/develop/Structure_oM/Results\Global Results\StructuralGlobalResult.cs)
