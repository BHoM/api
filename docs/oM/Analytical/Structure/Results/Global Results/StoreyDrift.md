...
???+ bhom "The StoreyDrift is inheriting from the following base type(s) and implements the following interfaces:"
...
|------------------|------------------|------------------|------------------|
| Storey | [string](https://learn.microsoft.com/en-us/dotnet/api/System.String?view=netstandard-2.0) | Storey name. | - |
| Direction | [Vector](/api/oM/Dimensional/Geometry/Vector/Vector) | Direction of the storey lateral displacement. | - |
| Ratio | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | Ratio between the storey drift and the storey height. | [Ratio](/api/oM/Dimensional/Quantities/Attributes/Ratio) [-] |
...
``` C# title="C#"
public class StoreyDrift : BH.oM.Structure.Results.StructuralGlobalResult,
...
- [StoreyDrift.cs](https://github.com/BHoM/BHoM/blob/develop/Structure_oM/Results\Global Results\StoreyDrift.cs)
