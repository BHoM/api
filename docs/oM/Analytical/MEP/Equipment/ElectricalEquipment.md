...
???+ bhom "The ElectricalEquipment is inheriting from the following base type(s) and implements the following interfaces:"
...
| ElectricalEquipmentType | [ElectricalEquipmentType](/api/oM/Analytical/MEP/Enums/ElectricalEquipmentType) | A type which describes the electrical equipment, more specifically whether it's switchgear, panelboard, transformer, etc. | - |
| Parts | [List](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1?view=netstandard-2.0)&lt;[IPart](/api/oM/Analytical/MEP/Equipment/Parts/IPart)&gt; | A collection of the parts (Electrical Connector) that make up the Electrical Equipment | - |
| Power | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | The power of the electrical equipment described in kilowatts. | - |
...
``` C# title="C#"
public class ElectricalEquipment : BH.oM.Base.BHoMObject,
...
- [ElectricalEquipment.cs](https://github.com/BHoM/BHoM/blob/develop/MEP_oM/Equipment\ElectricalEquipment.cs)
...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/MEP_oM/Equipment/ElectricalEquipment.json"
}
```

The JSON Schema is available on github here:

- [ElectricalEquipment.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/MEP_oM/Equipment/ElectricalEquipment.json)
