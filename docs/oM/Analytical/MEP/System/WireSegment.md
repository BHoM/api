...
???+ bhom "The WireSegment is inheriting from the following base type(s) and implements the following interfaces:"
...
|------------------|------------------|------------------|------------------|
| StartPoint | [Point](/api/oM/Dimensional/Geometry/Vector/Point) | The point at which the Wire object begins. | - |
| EndPoint | [Point](/api/oM/Dimensional/Geometry/Vector/Point) | The point at which the Wire object ends. | - |
| FlowRate | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | The amount of current being carried by the wire, the ampacity of the wire. | - |
| SectionProperty | [WireSectionProperty](/api/oM/Analytical/MEP/System/SectionProperties/WireSectionProperty) | Section property of the Wire, containing all material as well as profile geometry and dimensions, where applicable. | - |
...
| MaterialComposition | [MaterialComposition](/api/oM/Physical/Physical/Materials/MaterialComposition) | Gets all the Materials a wire is composed of and in which ratios | [Ratio](/api/oM/Dimensional/Quantities/Attributes/Ratio) [-] | MEP_Engine |
...
``` C# title="C#"
public class WireSegment : BH.oM.Base.BHoMObject,
...
- [WireSegment.cs](https://github.com/BHoM/BHoM/blob/develop/MEP_oM/System\WireSegment.cs)
...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/MEP_oM/System/WireSegment.json"
}
```

The JSON Schema is available on github here:

- [WireSegment.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/MEP_oM/System/WireSegment.json)
