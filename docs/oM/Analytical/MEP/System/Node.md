...
# <small>BH.oM.MEP.System.</small>**Node**
...
- [Node.cs](https://github.com/BHoM/BHoM/blob/develop/MEP_oM/System\Node.cs)
...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/MEP_oM/System/Node.json"
}
```

The JSON Schema is available on github here:

- [Node.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/MEP_oM/System/Node.json)
