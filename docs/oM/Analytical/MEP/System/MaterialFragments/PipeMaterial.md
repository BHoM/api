...
???+ bhom "The PipeMaterial is inheriting from the following base type(s) and implements the following interfaces:"
...
``` C# title="C#"
public class PipeMaterial : BH.oM.Base.BHoMObject,
