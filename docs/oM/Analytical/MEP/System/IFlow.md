...
???+ bhom "The IFlow is inheriting from the following base type(s) and implements the following interfaces:"
...
|------------------|------------------|------------------|------------------|
| StartPoint | [Point](/api/oM/Dimensional/Geometry/Vector/Point) | The point at which the Flow Object begins. | - |
| EndPoint | [Point](/api/oM/Dimensional/Geometry/Vector/Point) | The point at which the Flow Object ends. | - |
...
``` C# title="C#"
public interface IFlow : BH.oM.Base.IBHoMObject,
BH.oM.Base.IObject,
...
- [IFlow.cs](https://github.com/BHoM/BHoM/blob/develop/MEP_oM/System\IFlow.cs)
...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/MEP_oM/System/IFlow.json"
}
```

The JSON Schema is available on github here:

- [IFlow.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/MEP_oM/System/IFlow.json)
