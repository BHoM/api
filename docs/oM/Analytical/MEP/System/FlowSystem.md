...
???+ bhom "The FlowSystem is inheriting from the following base type(s) and implements the following interfaces:"
...
|------------------|------------------|------------------|------------------|
| FlowObjects | [List](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1?view=netstandard-2.0)&lt;[IFlow](/api/oM/Analytical/MEP/System/IFlow)&gt; | A collection of FlowObjects to compile within a specified systemType. | - |
| SystemType | [ISystemType](/api/oM/Analytical/MEP/System/ISystemType) | A specific system type to be applied to the flow objects. The system type describes the material conveyed by the system (supply air, cold water), therefore determining the behaviours of the system | - |
...
- [FlowSystem.cs](https://github.com/BHoM/BHoM/blob/develop/MEP_oM/System\FlowSystem.cs)
...
- [FlowSystem.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/MEP_oM/System/FlowSystem.json)
