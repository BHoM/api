...
???+ bhom "The Valve is inheriting from the following base type(s) and implements the following interfaces:"
...
| ValveType | [ValveType](/api/oM/Analytical/MEP/Enums/ValveType) | A type which describes the valve, more specifically whether it's a check valve, gate valve, etc. | - |
...
``` C# title="C#"
public class Valve : BH.oM.Base.BHoMObject, BH.oM.Base.IBHoMObject, BH.oM.Base.IObject, BH.oM.Dimensional.IElement0D, BH.oM.Dimensional.IElement
```
...
- [Valve.cs](https://github.com/BHoM/BHoM/blob/develop/MEP_oM/System\Valves\Valve.cs)
...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/MEP_oM/System/Dampers/Valve.json"
}
```

The JSON Schema is available on github here:

- [Valve.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/MEP_oM/System/Dampers/Valve.json)
