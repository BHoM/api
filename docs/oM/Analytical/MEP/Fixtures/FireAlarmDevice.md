...
???+ bhom "The FireAlarmDevice is inheriting from the following base type(s) and implements the following interfaces:"
...
| FireAlarmDeviceType | [FireAlarmDeviceType](/api/oM/Analytical/MEP/Enums/FireAlarmDeviceType) | A type which describes the fire alarm device more specifically whether it's a smoke detector, carbon monoxide detector or speaker strobe. | - |
...
``` C# title="C#"
public class FireAlarmDevice : BH.oM.Base.BHoMObject, BH.oM.Base.IBHoMObject, BH.oM.Base.IObject, BH.oM.Dimensional.IElement0D, BH.oM.Dimensional.IElement
```
...
- [FireAlarmDevice.cs](https://github.com/BHoM/BHoM/blob/develop/MEP_oM/Fixtures\FireAlarmDevice.cs)
...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/MEP_oM/Fixtures/FireAlarmDevice.json"
}
```

The JSON Schema is available on github here:

- [FireAlarmDevice.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/MEP_oM/Fixtures/FireAlarmDevice.json)
