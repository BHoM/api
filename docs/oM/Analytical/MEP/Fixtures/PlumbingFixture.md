...
???+ bhom "The PlumbingFixture is inheriting from the following base type(s) and implements the following interfaces:"
...
| PlumbingFixtureType | [PlumbingFixtureType](/api/oM/Analytical/MEP/Enums/PlumbingFixtureType) | A type which describes the plumbing fixture more specifically whether it's a water closet (toilet), urinal or lavatory. | - |
| Flow | [PlumbingFlowFragment](/api/oM/Analytical/MEP/Fragments/PlumbingFlowFragment) | Depiction of the plumbing flow associated with the plumbing fixture (cold water, hot water and drainage.) | - |
| LoadingFixtureUnits | [PlumbingLoadingFixtureUnitFragment](/api/oM/Analytical/MEP/Fragments/PlumbingLoadingFixtureUnitFragment) | Depiction of the plumbing loading/fixture units associated with the plumbing fixture (cold water, hot water and drainage.) | - |
...
``` C# title="C#"
public class PlumbingFixture : BH.oM.Base.BHoMObject, BH.oM.Base.IBHoMObject, BH.oM.Base.IObject, BH.oM.Dimensional.IElement0D, BH.oM.Dimensional.IElement
```
...
- [PlumbingFixture.cs](https://github.com/BHoM/BHoM/blob/develop/MEP_oM/Fixtures\PlumbingFixture.cs)
...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/MEP_oM/Fixtures/PlumbingFixture.json"
}
```

The JSON Schema is available on github here:

- [PlumbingFixture.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/MEP_oM/Fixtures/PlumbingFixture.json)
