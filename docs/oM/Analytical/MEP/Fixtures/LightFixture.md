...
???+ bhom "The LightFixture is inheriting from the following base type(s) and implements the following interfaces:"
...
| LuminousFlux | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | The luminous flux is the measure of the perceived power of light. | - |
| ColourTemperature | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | The colour temperature is a means of describing the light fixture's appearance, measured in degrees Kelvin | - |
| ControlZone | [string](https://learn.microsoft.com/en-us/dotnet/api/System.String?view=netstandard-2.0) | A means of denoting light fixtures that should be controlled in a similar manner. | - |
| Power | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | The power of the light fixture described in kilowatts. | - |
| Parts | [List](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1?view=netstandard-2.0)&lt;[IPart](/api/oM/Analytical/MEP/Equipment/Parts/IPart)&gt; | A means of adding an electrical connector part to the light fixture's properties. Gives the ability to add the voltage, amps, and denotes if the fixture should be on emergency power. | - |
...
``` C# title="C#"
public class LightFixture : BH.oM.Base.BHoMObject, BH.oM.Base.IBHoMObject, BH.oM.Base.IObject, BH.oM.Dimensional.IElement0D, BH.oM.Dimensional.IElement
```
...
- [LightFixture.cs](https://github.com/BHoM/BHoM/blob/develop/MEP_oM/Fixtures\LightFixture.cs)
...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/MEP_oM/Fixtures/LightFixture.json"
}
```

The JSON Schema is available on github here:

- [LightFixture.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/MEP_oM/Fixtures/LightFixture.json)
