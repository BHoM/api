...
|------------------|------------------|------------------|------------------|
| ExternalEdges | [List](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1?view=netstandard-2.0)&lt;[FrameEdge](/api/oM/Analytical/Facade/Elements/FrameEdge)&gt; | A collection of Edge objects which defines the external boundary of the panel | - |
| Openings | [List](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1?view=netstandard-2.0)&lt;[Opening](/api/oM/Analytical/Facade/Elements/Opening)&gt; | A collection of cutouts or holes in a building surface/panel (e.g. Window, Door, Rooflight) | - |
...
| Type | [PanelType](/api/oM/Analytical/Facade/Elements/Enums/PanelType) | The type of surface (e.g. Exterior wall, interior wall, air gap). Use PanelType enum | - |
...
| GeneralMaterialTakeoff | [GeneralMaterialTakeoff](/api/oM/Physical/Physical/Materials/GeneralMaterialTakeoff) | Gets the general material takeoff from the panel object. The takeoff will contain materials and volumes, mass and areas from the panel itself, as well as takeoffs from any openings. | - | Facade_Engine |
...
| MaterialComposition | [MaterialComposition](/api/oM/Physical/Physical/Materials/MaterialComposition) | Gets all the Materials a Panel is composed of and in which ratios. | - | Facade_Engine |
...
| PrimaryPropertyName | [string](https://learn.microsoft.com/en-us/dotnet/api/System.String?view=netstandard-2.0) | Returns the name of a panel's construction property | - | Facade_Engine |
...
- [Panel.cs](https://github.com/BHoM/BHoM/blob/develop/Facade_oM/Elements\Panel.cs)
...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/Facade_oM/Elements/Panel.json"
}
```

The JSON Schema is available on github here:

- [Panel.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/Facade_oM/Elements/Panel.json)
