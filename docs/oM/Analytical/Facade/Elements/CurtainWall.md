...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/Facade_oM/Elements/CurtainWall.json"
}
```

The JSON Schema is available on github here:

- [CurtainWall.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/Facade_oM/Elements/CurtainWall.json)
