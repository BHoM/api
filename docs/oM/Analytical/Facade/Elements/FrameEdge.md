...
???+ bhom "The FrameEdge is inheriting from the following base type(s) and implements the following interfaces:"
...
|------------------|------------------|------------------|------------------|
| Curve | [ICurve](/api/oM/Dimensional/Geometry/Curve/ICurve) | The curve representing the frame edge location | - |
| FrameEdgeProperty | [FrameEdgeProperty](/api/oM/Analytical/Facade/SectionProperties/FrameEdgeProperty) | The property assigned to this frame edge | - |
...
| GeneralMaterialTakeoff | [GeneralMaterialTakeoff](/api/oM/Physical/Physical/Materials/GeneralMaterialTakeoff) | Gets the general material takeoff from the FrameEdge. | - | Facade_Engine |
...
| MaterialComposition | [MaterialComposition](/api/oM/Physical/Physical/Materials/MaterialComposition) | Gets all the Materials a Opening is composed of and in which ratios. | - | Facade_Engine |
...
| PrimaryPropertyName | [string](https://learn.microsoft.com/en-us/dotnet/api/System.String?view=netstandard-2.0) | Returns the name of a frameEdge's primary defining property | - | Facade_Engine |
| SolidVolume | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | Returns a FrameEdges solid volume based on its length and applied section properties | [Volume](/api/oM/Dimensional/Quantities/Attributes/Volume) [m³] | Facade_Engine |
...
``` C# title="C#"
public class FrameEdge : BH.oM.Base.BHoMObject,
...
- [FrameEdge.cs](https://github.com/BHoM/BHoM/blob/develop/Facade_oM/Elements\FrameEdge.cs)
...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/Facade_oM/Elements/FrameEdge.json"
}
```

The JSON Schema is available on github here:

- [FrameEdge.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/Facade_oM/Elements/FrameEdge.json)
