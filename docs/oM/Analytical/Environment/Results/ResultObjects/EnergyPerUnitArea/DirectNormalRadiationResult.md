...
???+ bhom "The DirectNormalRadiationResult is inheriting from the following base type(s) and implements the following interfaces:"
...
``` C# title="C#"
public class DirectNormalRadiationResult : BH.oM.Base.BHoMObject,
...
- [DirectNormalRadiationResult.cs](https://github.com/BHoM/BHoM/blob/develop/Environment_oM/Results\ResultObjects\EnergyPerUnitArea\DirectNormalRadiationResult.cs)
