...
???+ bhom "The DiffuseHorizontalRadiationResult is inheriting from the following base type(s) and implements the following interfaces:"
...
``` C# title="C#"
public class DiffuseHorizontalRadiationResult : BH.oM.Base.BHoMObject,
...
- [DiffuseHorizontalRadiationResult.cs](https://github.com/BHoM/BHoM/blob/develop/Environment_oM/Results\ResultObjects\EnergyPerUnitArea\DiffuseHorizontalRadiationResult.cs)
