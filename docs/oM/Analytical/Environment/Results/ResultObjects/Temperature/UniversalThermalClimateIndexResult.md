...
???+ bhom "The UniversalThermalClimateIndexResult is inheriting from the following base type(s) and implements the following interfaces:"
...
``` C# title="C#"
public class UniversalThermalClimateIndexResult : BH.oM.Base.BHoMObject,
