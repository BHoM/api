...
???+ bhom "The MeanRadiantTemperatureResult is inheriting from the following base type(s) and implements the following interfaces:"
...
``` C# title="C#"
public class MeanRadiantTemperatureResult : BH.oM.Base.BHoMObject,
...
- [MeanRadiantTemperatureResult.cs](https://github.com/BHoM/BHoM/blob/develop/Environment_oM/Results\ResultObjects\Temperature\MeanRadiantTemperatureResult.cs)
