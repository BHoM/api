...
???+ bhom "The WetBulbTemperatureResult is inheriting from the following base type(s) and implements the following interfaces:"
...
``` C# title="C#"
public class WetBulbTemperatureResult : BH.oM.Base.BHoMObject,
...
- [WetBulbTemperatureResult.cs](https://github.com/BHoM/BHoM/blob/develop/Environment_oM/Results\ResultObjects\Temperature\WetBulbTemperatureResult.cs)
