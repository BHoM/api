...
???+ bhom "The DewPointTemperatureResult is inheriting from the following base type(s) and implements the following interfaces:"
...
``` C# title="C#"
public class DewPointTemperatureResult : BH.oM.Base.BHoMObject,
...
- [DewPointTemperatureResult.cs](https://github.com/BHoM/BHoM/blob/develop/Environment_oM/Results\ResultObjects\Temperature\DewPointTemperatureResult.cs)
