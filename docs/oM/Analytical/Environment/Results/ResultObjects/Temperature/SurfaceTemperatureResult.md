...
???+ bhom "The SurfaceTemperatureResult is inheriting from the following base type(s) and implements the following interfaces:"
...
``` C# title="C#"
public class SurfaceTemperatureResult : BH.oM.Base.BHoMObject,
...
- [SurfaceTemperatureResult.cs](https://github.com/BHoM/BHoM/blob/develop/Environment_oM/Results\ResultObjects\Temperature\SurfaceTemperatureResult.cs)
