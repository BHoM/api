...
???+ bhom "The Building is inheriting from the following base type(s) and implements the following interfaces:"
...
| Type | [BuildingType](/api/oM/Analytical/Environment/Elements/Enums/BuildingType) | The main classification for the building (e.g. Office, Residential). Use BuildingType enum) | - |
...
- [Building.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/Environment_oM/Elements/Building.json)
