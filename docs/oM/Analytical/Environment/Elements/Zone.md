...
???+ bhom "The Zone is inheriting from the following base type(s) and implements the following interfaces:"
...
| Perimeter | [ICurve](/api/oM/Dimensional/Geometry/Curve/ICurve) | A 2D curve defining the external boundaries of the floor of the region. | - |
...
``` C# title="C#"
public class Zone : BH.oM.Base.BHoMObject,
...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/Environment_oM/Elements/Zone.json"
}
```

The JSON Schema is available on github here:

- [Zone.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/Environment_oM/Elements/Zone.json)
