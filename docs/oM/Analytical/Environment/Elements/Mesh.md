...
|------------------|------------------|------------------|------------------|
| Mesh3D | [Mesh3D](/api/oM/Dimensional/Geometry/Mesh/Mesh3D) | Defines the three-dimensional Mesh geometry. | - |
| BoundaryZones | [List](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1?view=netstandard-2.0)&lt;[BoundaryZone](/api/oM/Analytical/Environment/Elements/BoundaryZone)&gt; | Defines the partition of the meshes external faces. | - |
...
``` C# title="C#"
public class Mesh : BH.oM.Base.BHoMObject, BH.oM.Base.IBHoMObject, BH.oM.Base.IObject, BH.oM.Environment.IEnvironmentObject
```
...
- [Mesh.cs](https://github.com/BHoM/BHoM/blob/develop/Environment_oM/Elements\Mesh.cs)
...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/Environment_oM/Elements/Mesh.json"
}
```

The JSON Schema is available on github here:

- [Mesh.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/Environment_oM/Elements/Mesh.json)
