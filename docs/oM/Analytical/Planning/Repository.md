...
???+ bhom "The Repository is inheriting from the following base type(s) and implements the following interfaces:"
...
``` C# title="C#"
public class Repository : BH.oM.Base.BHoMObject, BH.oM.Base.IBHoMObject, BH.oM.Base.IObject
```
