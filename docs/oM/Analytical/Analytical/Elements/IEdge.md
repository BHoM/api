...
???+ bhom "The IEdge is inheriting from the following base type(s) and implements the following interfaces:"
...
``` C# title="C#"
public interface IEdge : BH.oM.Base.IBHoMObject,
BH.oM.Base.IObject,
...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/Analytical_oM/Elements/IEdge.json"
}
```

The JSON Schema is available on github here:

- [IEdge.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/Analytical_oM/Elements/IEdge.json)
