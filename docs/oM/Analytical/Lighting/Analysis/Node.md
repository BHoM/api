...
- [Node.cs](https://github.com/BHoM/BHoM/blob/develop/Lighting_oM/Analysis\Node.cs)
...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/Lighting_oM/Analysis/Node.json"
}
```

The JSON Schema is available on github here:

- [Node.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/Lighting_oM/Analysis/Node.json)
