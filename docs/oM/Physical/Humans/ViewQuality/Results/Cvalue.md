...
???+ bhom "The Cvalue is inheriting from the following base type(s) and implements the following interfaces:"
...
|------------------|------------------|------------------|------------------|
| CValue | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | - | - |
| HorizDist | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | - | - |
| HeightAbovePitch | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | - | - |
| AbsoluteDist | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | - | - |
...
``` C# title="C#"
public class Cvalue : BH.oM.Humans.ViewQuality.ViewQualityResult,
...
- [Cvalue.cs](https://github.com/BHoM/BHoM/blob/develop/Humans_oM/ViewQuality\Results\Cvalue.cs)
