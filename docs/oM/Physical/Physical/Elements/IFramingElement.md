...
???+ bhom "The IFramingElement is inheriting from the following base type(s) and implements the following interfaces:"
...
``` C# title="C#"
public interface IFramingElement : BH.oM.Base.IBHoMObject,
BH.oM.Base.IObject,
...
- [IFramingElement.cs](https://github.com/BHoM/BHoM/blob/develop/Physical_oM/Elements\IFramingElement.cs)
...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/Physical_oM/Elements/IFramingElement.json"
}
```

The JSON Schema is available on github here:

- [IFramingElement.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/Physical_oM/Elements/IFramingElement.json)
