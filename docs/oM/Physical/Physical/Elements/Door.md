...
| GeneralMaterialTakeoff | [GeneralMaterialTakeoff](/api/oM/Physical/Physical/Materials/GeneralMaterialTakeoff) | Gets the volumetric material takeoff from the Door. | - | Physical_Engine |
| Height | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | Returns the vertical orthogonal height of a door object based on global coordinates of its BoundingBox. | - | Physical_Engine |
...
| VolumetricMaterialTakeoff | [VolumetricMaterialTakeoff](/api/oM/Physical/Physical/Materials/VolumetricMaterialTakeoff) | Gets the volumetric material takeoff from the Door. | - | Physical_Engine |
| Width | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | Returns the horizontal orthogonal width of a door object based on global coordinates of its BoundingBox. | - | Physical_Engine |
...
``` C# title="C#"
public class Door : BH.oM.Base.BHoMObject,
...
- [Door.cs](https://github.com/BHoM/BHoM/blob/develop/Physical_oM/Elements\Door.cs)
...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/Physical_oM/Elements/Door.json"
}
```

The JSON Schema is available on github here:

- [Door.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/Physical_oM/Elements/Door.json)
