...
|------------------|------------------|------------------|------------------|
| Location | [PlanarSurface](/api/oM/Dimensional/Geometry/Surface/PlanarSurface) | PlanarSurface defining the top face of a pad foundation. | - |
| Construction | [IConstruction](/api/oM/Physical/Physical/Constructions/IConstruction) | Construction of the pad foundation defining its thickness and Material. | - |
...
| Geometry | [IGeometry](/api/oM/Dimensional/Geometry/Interface/IGeometry) | Gets the geometry of a PadFoundation as a surface. Method required for automatic display in UI packages. | - | Physical_Engine |
...
| MaterialComposition | [MaterialComposition](/api/oM/Physical/Physical/Materials/MaterialComposition) | Gets all the Materials a PadFoundation is composed of and in which ratios. | - | Physical_Engine |
...
| OutlineElements1D | [List](https://learn.microsoft.com/en-us/dotnet/api/System.Collections.Generic.List-1?view=netstandard-2.0)&lt;[IElement1D](/api/oM/Dimensional/Dimensional/IElement1D)&gt; | Gets the external outline elements of a PadFoundation. | - | Physical_Engine |
...
| SolidVolume | [double](https://learn.microsoft.com/en-us/dotnet/api/System.Double?view=netstandard-2.0) | Returns the solid volume of a PadFoundation based on the thickness and area. | [Volume](/api/oM/Dimensional/Quantities/Attributes/Volume) [m³] | Physical_Engine |
| VolumetricMaterialTakeoff | [VolumetricMaterialTakeoff](/api/oM/Physical/Physical/Materials/VolumetricMaterialTakeoff) | Gets the volumetric material takeoff from a PadFoundation. | - | Physical_Engine |
...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/Physical_oM/Elements/PadFoundation.json"
}
```

The JSON Schema is available on github here:

- [PadFoundation.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/Physical_oM/Elements/PadFoundation.json)
