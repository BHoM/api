...
???+ bhom "The ShapeCode34 is inheriting from the following base type(s) and implements the following interfaces:"
...
``` C# title="C#"
public class ShapeCode34 : BH.oM.Base.BHoMObject,
...
- [ShapeCode34.cs](https://github.com/BHoM/BHoM/blob/develop/Physical_oM/Reinforcement\BS8666\ShapeCode34.cs)
