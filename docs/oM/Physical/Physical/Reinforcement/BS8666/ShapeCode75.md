...
# <small>BH.oM.Physical.Reinforcement.BS8666.</small>**ShapeCode75**
...
???+ bhom "The ShapeCode75 is inheriting from the following base type(s) and implements the following interfaces:"
...
- [ShapeCode75.cs](https://github.com/BHoM/BHoM/blob/develop/Physical_oM/Reinforcement\BS8666\ShapeCode75.cs)
