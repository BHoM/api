...
???+ bhom "The ShapeCode52 is inheriting from the following base type(s) and implements the following interfaces:"
...
``` C# title="C#"
public class ShapeCode52 : BH.oM.Base.BHoMObject,
...
- [ShapeCode52.cs](https://github.com/BHoM/BHoM/blob/develop/Physical_oM/Reinforcement\BS8666\ShapeCode52.cs)
