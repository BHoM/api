...
???+ bhom "The ShapeCode23 is inheriting from the following base type(s) and implements the following interfaces:"
...
| ZBar | [bool](https://learn.microsoft.com/en-us/dotnet/api/System.Boolean?view=netstandard-2.0) | When toggled true, the bar will be rotated 90 degrees to form a Z bar. | - |
...
``` C# title="C#"
public class ShapeCode23 : BH.oM.Base.BHoMObject,
...
- [ShapeCode23.cs](https://github.com/BHoM/BHoM/blob/develop/Physical_oM/Reinforcement\BS8666\ShapeCode23.cs)
