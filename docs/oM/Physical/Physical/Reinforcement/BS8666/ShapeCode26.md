...
# <small>BH.oM.Physical.Reinforcement.BS8666.</small>**ShapeCode26**

A reinforcement bar with shape code 26 to BS 8666:2020 in the XY Plane with the free end of the A segment starting at the Origin aligned with the X axis, the C/E parameters aligned with the X axis and the D parameter aligned with the Y axis.

## Class structure

### Implemented interfaces and base types

???+ bhom "The ShapeCode26 is inheriting from the following base type(s) and implements the following interfaces:"
...
``` C# title="C#"
public class ShapeCode26 : BH.oM.Base.BHoMObject,
...
- [ShapeCode26.cs](https://github.com/BHoM/BHoM/blob/develop/Physical_oM/Reinforcement\BS8666\ShapeCode26.cs)
