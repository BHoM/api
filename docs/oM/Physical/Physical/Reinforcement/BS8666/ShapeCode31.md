...
# <small>BH.oM.Physical.Reinforcement.BS8666.</small>**ShapeCode31**
...
???+ bhom "The ShapeCode31 is inheriting from the following base type(s) and implements the following interfaces:"
...
- [ShapeCode31.cs](https://github.com/BHoM/BHoM/blob/develop/Physical_oM/Reinforcement\BS8666\ShapeCode31.cs)
