...
???+ bhom "The ShapeCode27 is inheriting from the following base type(s) and implements the following interfaces:"
...
``` C# title="C#"
public class ShapeCode27 : BH.oM.Base.BHoMObject,
