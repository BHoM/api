...
???+ bhom "The ShapeCode63 is inheriting from the following base type(s) and implements the following interfaces:"
...
``` C# title="C#"
public class ShapeCode63 : BH.oM.Base.BHoMObject,
...
- [ShapeCode63.cs](https://github.com/BHoM/BHoM/blob/develop/Physical_oM/Reinforcement\BS8666\ShapeCode63.cs)
