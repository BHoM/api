...
???+ bhom "The ShapeCode67 is inheriting from the following base type(s) and implements the following interfaces:"
...
``` C# title="C#"
public class ShapeCode67 : BH.oM.Base.BHoMObject,
...
- [ShapeCode67.cs](https://github.com/BHoM/BHoM/blob/develop/Physical_oM/Reinforcement\BS8666\ShapeCode67.cs)
