...
# <small>BH.oM.Physical.Reinforcement.BS8666.</small>**ShapeCode28**

A reinforcement bar with shape code 28 to BS 8666:2020 in the XY Plane with the free end of A segment starting at the Origin, the B/E parameters aligned with the X axis and the C/D parameters aligned with the Y axis.

## Class structure

### Implemented interfaces and base types

???+ bhom "The ShapeCode28 is inheriting from the following base type(s) and implements the following interfaces:"
...
``` C# title="C#"
public class ShapeCode28 : BH.oM.Base.BHoMObject,
...
- [ShapeCode28.cs](https://github.com/BHoM/BHoM/blob/develop/Physical_oM/Reinforcement\BS8666\ShapeCode28.cs)
