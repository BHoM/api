...
???+ bhom "The ShapeCode21 is inheriting from the following base type(s) and implements the following interfaces:"
...
``` C# title="C#"
public class ShapeCode21 : BH.oM.Base.BHoMObject,
...
- [ShapeCode21.cs](https://github.com/BHoM/BHoM/blob/develop/Physical_oM/Reinforcement\BS8666\ShapeCode21.cs)
