...
# <small>BH.oM.Adapters.GSA.SurfaceProperties.</small>**FabricPanelProperty**
...
???+ bhom "The FabricPanelProperty is inheriting from the following base type(s) and implements the following interfaces:"
...
| Material | [IMaterialFragment](/api/oM/Analytical/Structure/MaterialFragments/IMaterialFragment) | Fabric material. | - |
...
| SoapStress | [SoapStress2D](/api/oM/Adapter/Adapters/GSA/FormFindingProperties/SoapStress2D) | Soap stress property if applicable. | - |
...
``` C# title="C#"
public class FabricPanelProperty : BH.oM.Base.BHoMObject,
...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/GSA_oM/SurfaceProperties/FabricPanelProperty.json"
}
```

The JSON Schema is available on github here:

- [FabricPanelProperty.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/GSA_oM/SurfaceProperties/FabricPanelProperty.json)
