...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/MidasCivil_oM/TimeHistorySettings.json"
}
```

The JSON Schema is available on github here:

- [TimeHistorySettings.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/MidasCivil_oM/TimeHistorySettings.json)
