...
{
 "$ref" : "https://raw.githubusercontent.com/BHoM/BHoM_JSONSchema/develop/SQL_oM/SqlClientAssemblyFixSettings.json"
}
```

The JSON Schema is available on github here:

- [SqlClientAssemblyFixSettings.json](https://github.com/BHoM/BHoM_JSONSchema/blob/develop/SQL_oM/SqlClientAssemblyFixSettings.json)
